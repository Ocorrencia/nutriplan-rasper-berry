...
/**
 * <p>Classe Java de opListaTurnoOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opListaTurnoOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opListaTurnoOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opListaTurnoOut", propOrder = {
    "consultar",
    "erroExecucao",
    "mensagemRetorno"
})
public class OpListaTurnoOut {

    @XmlElement(nillable = true)
    protected List<OpListaTurnoOutConsultar> consultar;
     ...
     * {@link OpListaTurnoOutConsultar }
     * 
     * 
     */
    public List<OpListaTurnoOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpListaTurnoOutConsultar>();
        }
