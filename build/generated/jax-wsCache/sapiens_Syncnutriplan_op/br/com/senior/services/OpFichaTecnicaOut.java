...
/**
 * <p>Classe Java de opFichaTecnicaOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opFichaTecnicaOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opFichaTecnicaOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opFichaTecnicaOut", propOrder = {
    "consultar",
    "erroExecucao"
})
public class OpFichaTecnicaOut {

    @XmlElement(nillable = true)
    protected List<OpFichaTecnicaOutConsultar> consultar;
     ...
     * {@link OpFichaTecnicaOutConsultar }
     * 
     * 
     */
    public List<OpFichaTecnicaOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpFichaTecnicaOutConsultar>();
        }
