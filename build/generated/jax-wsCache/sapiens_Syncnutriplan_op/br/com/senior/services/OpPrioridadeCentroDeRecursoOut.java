...
/**
 * <p>Classe Java de opPrioridadeCentroDeRecursoOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opPrioridadeCentroDeRecursoOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opPrioridadeCentroDeRecursoOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opPrioridadeCentroDeRecursoOut", propOrder = {
    "consultar",
    "erroExecucao",
    "mensagemRetorno"
})
public class OpPrioridadeCentroDeRecursoOut {

    @XmlElement(nillable = true)
    protected List<OpPrioridadeCentroDeRecursoOutConsultar> consultar;
     ...
     * {@link OpPrioridadeCentroDeRecursoOutConsultar }
     * 
     * 
     */
    public List<OpPrioridadeCentroDeRecursoOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpPrioridadeCentroDeRecursoOutConsultar>();
        }
