...
/**
 * <p>Classe Java de opMotivoParadaOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opMotivoParadaOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opMotivoParadaOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opMotivoParadaOut", propOrder = {
    "consultar",
    "erroExecucao",
    "mensagemRetorno"
})
public class OpMotivoParadaOut {

    @XmlElement(nillable = true)
    protected List<OpMotivoParadaOutConsultar> consultar;
     ...
     * {@link OpMotivoParadaOutConsultar }
     * 
     * 
     */
    public List<OpMotivoParadaOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpMotivoParadaOutConsultar>();
        }
