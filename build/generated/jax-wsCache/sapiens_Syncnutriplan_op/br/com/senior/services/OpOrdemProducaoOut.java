...
/**
 * <p>Classe Java de opOrdemProducaoOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opOrdemProducaoOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opOrdemProducaoOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opOrdemProducaoOut", propOrder = {
    "consultar",
    "erroExecucao",
    "mensagemRetorno"
})
public class OpOrdemProducaoOut {

    @XmlElement(nillable = true)
    protected List<OpOrdemProducaoOutConsultar> consultar;
     ...
     * {@link OpOrdemProducaoOutConsultar }
     * 
     * 
     */
    public List<OpOrdemProducaoOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpOrdemProducaoOutConsultar>();
        }
