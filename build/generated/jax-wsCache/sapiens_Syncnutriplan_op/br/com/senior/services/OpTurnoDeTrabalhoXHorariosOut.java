...
/**
 * <p>Classe Java de opTurnoDeTrabalhoXHorariosOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opTurnoDeTrabalhoXHorariosOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opTurnoDeTrabalhoXHorariosOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opTurnoDeTrabalhoXHorariosOut", propOrder = {
    "consultar",
    "erroExecucao",
    "mensagemRetorno"
})
public class OpTurnoDeTrabalhoXHorariosOut {

    @XmlElement(nillable = true)
    protected List<OpTurnoDeTrabalhoXHorariosOutConsultar> consultar;
     ...
     * {@link OpTurnoDeTrabalhoXHorariosOutConsultar }
     * 
     * 
     */
    public List<OpTurnoDeTrabalhoXHorariosOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpTurnoDeTrabalhoXHorariosOutConsultar>();
        }
