...
/**
 * <p>Classe Java de opCentroDeRecursoOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="opCentroDeRecursoOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="consultar" type="{http://services.senior.com.br}opCentroDeRecursoOutConsultar" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "opCentroDeRecursoOut", propOrder = {
    "consultar",
    "erroExecucao",
    "mensagemRetorno"
})
public class OpCentroDeRecursoOut {

    @XmlElement(nillable = true)
    protected List<OpCentroDeRecursoOutConsultar> consultar;
     ...
     * {@link OpCentroDeRecursoOutConsultar }
     * 
     * 
     */
    public List<OpCentroDeRecursoOutConsultar> getConsultar() {
        if (consultar == null) {
            consultar = new ArrayList<OpCentroDeRecursoOutConsultar>();
        }
